class Trip < ApplicationRecord
    ...
    validates :avatar, content_type: ['image/png', 'image/jpeg', 'image/jpg'], size: { less_than: 8000.kilobytes , message: 'image size is too large, it should less than 8 MB' } #attached: true,
